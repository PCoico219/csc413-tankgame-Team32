  ...
  implements Runnable
{
  ...
  private final int battleField_X_Size = 1536;
  private final int battleField_Y_Size = 1536;
  ...
  private BufferedImage player_1_window;
  private BufferedImage player_2_window;
  ...
  public static void main(String[] argv)
  {
    ...
    f.pack();
    Objects.requireNonNull(TANKGAME);Objects.requireNonNull(TANKGAME);f.setSize(new Dimension(900, 600));
    f.setVisible(true);
